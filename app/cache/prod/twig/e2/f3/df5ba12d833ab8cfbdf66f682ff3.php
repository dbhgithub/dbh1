...
\$.vegas('slideshow', {
  ...
  backgrounds:[
    ";
        // line 31
        if (isset($context["banners"])) { $_banners_ = $context["banners"]; } else { $_banners_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_banners_);
        foreach ($context['_seq'] as $context["_key"] => $context["d"]) {
            echo "      
    { src:\"";
            // line 32
            if (isset($context["d"])) { $_d_ = $context["d"]; } else { $_d_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl($this->getAttribute($_d_, "image")), "html", null, true);
            echo "\", fade:1000 },
    ";
        }
